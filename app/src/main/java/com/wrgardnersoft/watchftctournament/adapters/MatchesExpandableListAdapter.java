...
import com.wrgardnersoft.watchftctournament.activities.MyTeamActivity;
...
public class MatchesExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, List<com.wrgardnersoft.watchftctournament.models.Match>> _listDataChild;
